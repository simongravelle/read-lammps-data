...
class ReadLammpsData():
    ...
    def analyse(self, line, datafile):
        def could_not_read(unknown):
            if self.verbose:
                print("Could not decipher: "+str(unknown)+" on line "+str(self.count))
    ...
    def validate(self):
        for attribute in self.attributes:
            try:
                ...
                if self.verbose:
                    print("WARNING: undefined " + str(attribute))
